    ...
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            <p style={{ color: isDark ? '#94A3B8' : '#64748B', fontSize: '14px', marginBottom: '8px', fontWeight: 500 }}>
              แจ้งเตือน
            </p>
            <motion.h3
              initial={{ scale: 0.5 }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '4px' }}>
              <p style={{ color: isDark ? '#64748B' : '#94A3B8', fontSize: '13px', margin: 0 }}>
                จุดที่ต้องเฝ้าระวัง
              </p>
              {hasAlerts && (
                <motion.div
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <div>
                        <p style={{ color: isDark ? '#F8FAFC' : '#1E293B', fontSize: '14px', fontWeight: 500, margin: 0 }}>
                          {sensor.location || sensor.name}
                        </p>
                        <p style={{ color: isDark ? '#64748B' : '#94A3B8', fontSize: '12px', margin: '2px 0 0' }}>
                          {sensor.name}
                        </p>
                      </div>
                    </div>
