        ...
        <>
          ...
          >
            ...
            <div style={{ marginBottom: '28px' }}>
              <h3 style={{ color: '#94A3B8', fontSize: '13px', fontWeight: 600, marginBottom: '16px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                ระดับค่าควัน (PPM)
              </h3>
              ...
              <div style={{ marginBottom: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                  ...
                  <label style={{ color: '#F8FAFC', fontSize: '15px', fontWeight: 500 }}>
                    ระดับเฝ้าระวัง
                  </label>
                  <span style={{ 
                    marginLeft: 'auto', 
                ...
                <input
                  ...
                  style={{
                    ...
                    height: '8px',
                    borderRadius: '4px',
                    background: `linear-gradient(to right, #F59E0B ${(localSettings.warningThreshold / 150) * 100}%, rgba(255,255,255,0.1) 0%)`,
                    appearance: 'none',
                    cursor: 'pointer',
                  }}
                />
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    ...
                    height: '8px',
                    borderRadius: '4px',
                    background: `linear-gradient(to right, #EF4444 ${(localSettings.dangerThreshold / 500) * 100}%, rgba(255,255,255,0.1) 0%)`,
                    appearance: 'none',
                    cursor: 'pointer',
                  }}
                />
            ...
            <div style={{
              ...
              <p style={{ color: '#64748B', fontSize: '12px', marginBottom: '12px', fontWeight: 500 }}>
                ตัวอย่างระดับ:
              </p>
              <div style={{ display: 'flex', gap: '8px' }}>
                <div style={{ flex: 1, textAlign: 'center', padding: '10px', background: 'rgba(16, 185, 129, 0.15)', borderRadius: '10px', border: '1px solid rgba(16, 185, 129, 0.3)' }}>
                  ...
                  <p style={{ color: '#64748B', fontSize: '10px' }}>0-{localSettings.warningThreshold - 1}</p>
                </div>
                <div style={{ flex: 1, textAlign: 'center', padding: '10px', background: 'rgba(245, 158, 11, 0.15)', borderRadius: '10px', border: '1px solid rgba(245, 158, 11, 0.3)' }}>
                  ...
                  <p style={{ color: '#64748B', fontSize: '10px' }}>{localSettings.warningThreshold}-{localSettings.dangerThreshold - 1}</p>
                </div>
                <div style={{ flex: 1, textAlign: 'center', padding: '10px', background: 'rgba(239, 68, 68, 0.15)', borderRadius: '10px', border: '1px solid rgba(239, 68, 68, 0.3)' }}>
                  ...
                  <p style={{ color: '#64748B', fontSize: '10px' }}>{localSettings.dangerThreshold}+</p>
                </div>
              </div>
            </div>
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: localSettings.pollingInterval === option.value ? '#3B82F6' : '#94A3B8',
                      fontSize: '13px',
                      fontWeight: 600,
                      cursor: 'pointer',
                      transition: 'all 0.2s',
            ...
            <div style={{ marginBottom: '28px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <label style={{
                  ...
                  <Volume2 size={20} color={localSettings.enableSoundAlert ? '#10B981' : '#64748B'} />
                  <span style={{ color: '#F8FAFC', fontSize: '14px', flex: 1 }}>เสียงแจ้งเตือน</span>
                  <div
                    ...
                    style={{
                      ...
                      height: '26px',
                      borderRadius: '13px',
                      background: localSettings.enableSoundAlert ? '#10B981' : 'rgba(255, 255, 255, 0.1)',
                      position: 'relative',
                ...
                <label style={{
                  ...
                  <Bell size={20} color={localSettings.enableNotification ? '#10B981' : '#64748B'} />
                  <span style={{ color: '#F8FAFC', fontSize: '14px', flex: 1 }}>การแจ้งเตือนเบราว์เซอร์</span>
                  <div
                    ...
                    style={{
                      ...
                      height: '26px',
                      borderRadius: '13px',
                      background: localSettings.enableNotification ? '#10B981' : 'rgba(255, 255, 255, 0.1)',
                      position: 'relative',
                      transition: 'background 0.2s',
                      cursor: 'pointer',
                    }}
